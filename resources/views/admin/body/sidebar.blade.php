<div class="app-sidebar-menu">
    ...
    <a href="{{ route('dashboard') }}" class="logo logo-light">
        <span class="logo-sm">
            <span style="font-weight: bold; font-size: 20px; color: #fff;">V</span>
        </span>
        <span class="logo-lg">
            <span style="font-weight: bold; font-size: 22px; color: #fff; letter-spacing: 1px;">V-CELL</span>
        </span>
    </a>
    <a href="{{ route('dashboard') }}" class="logo logo-dark">
        <span class="logo-sm">
            <span style="font-weight: bold; font-size: 20px; color: #333;">V</span>
        </span>
        <span class="logo-lg">
            <span style="font-weight: bold; font-size: 22px; color: #333; letter-spacing: 1px;">V-CELL</span>
        </span>
    </a>
</div>
