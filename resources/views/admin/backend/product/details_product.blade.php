                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                        ...
                        <div class="d-flex flex-wrap justify-content-center">
                            @forelse ($product->images as $image)
                                <img src="{{ asset($image->image) }}" alt="image" class="me-2 mb-2" width="200" height="200" style="object-fit: cover; border: 1px solid #ddd; border-radius: 5px"> 
                            @empty
                    ...
                    <div class="col-md-8">
                        ...
                        <ul class="list-group">
                            ...
                            {{-- // Hardcoded untuk menghindari Error Property on Null --}}
