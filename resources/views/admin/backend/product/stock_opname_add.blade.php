                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('store.stock.opname') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10"><input name="tanggal_so" class="form-control" type="date" value="{{ date('Y-m-d') }}" required></div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10"><input class="form-control" type="number" id="stok_sistem" readonly style="background-color: #f4f4f4;"></div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label text-success">Qty Tambah (+)</label>
                                <div class="col-sm-10"><input name="qty_tambah" class="form-control" type="number" id="qty_tambah" value="0" oninput="calculateTotal()"></div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label text-danger">Qty Kurang (-)</label>
                                <div class="col-sm-10"><input name="qty_kurang" class="form-control" type="number" id="qty_kurang" value="0" oninput="calculateTotal()"></div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Total Stok Fisik Akhir</label>
                                <div class="col-sm-10"><input class="form-control" type="number" id="stok_fisik" readonly style="font-weight: bold; color: blue;"></div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Alasan</label>
                                <div class="col-sm-10"><textarea name="alasan" class="form-control" rows="3" required></textarea></div>
                            </div>
                            <div class="row mb-3">
