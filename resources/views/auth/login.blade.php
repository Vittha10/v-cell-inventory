...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Login | V-CELL Inventory</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="V-CELL Inventory Management System"/>
        <meta name="author" content="V-CELL Team"/>
                                ...
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    <div class="mb-4 p-0">
                                        <a href="/" class="auth-logo">
                                            <h2 class="fw-bold text-dark mb-0">V-<span class="text-primary">CELL</span></h2>
                                        </a>
                                    </div>
                    ...
                    <div class="col-xl-7">
                        <div class="account-page-bg p-md-5 p-4">
                            <div class="text-center">
                                <h3 class="text-dark mb-3 pera-title">Login Page for V-CELL Inventory System</h3>
